# line-cat-demo Specification

## Purpose

Определяет browser example `examples/line_cat/index.html`, который демонстрирует line-based primitives Decartes.js через простой рисунок котика.
